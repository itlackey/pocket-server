 ...
 *
 * @fileoverview Conversation title generation with fallback logic
 */
 ...
 * @param {string} [anthropicApiKey] - Anthropic API key (optional)
 * @returns {Promise<string>} Generated title
 */
export async function generateConversationTitle(userMessage, anthropicApiKey) {
...
/**
 * Generate a fallback title using heuristics
