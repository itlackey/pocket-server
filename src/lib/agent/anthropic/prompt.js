...
/**
 * @typedef {Object} SystemPromptParams
 * @property {string} workingDirectory
 * @property {string} [platform]
 * @property {string} [osVersion]
 * @property {Object} [projectContext]
 * @property {string} projectContext.sourcePath
 * @property {string} projectContext.content
 */

/**
 * Generate system prompt with current context
 * @param {SystemPromptParams} params - The parameters for generating the system prompt
